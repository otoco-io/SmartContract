...
contract OtoCoMasterV2Mock is OwnableUpgradeable, ERC721Upgradeable {
    ...
    /**
     * Upgradeable contract initializer.Mock
     *
     * @param jurisdictionAddresses Initial juridiction pre-deployed addresses.
     * @param url Initial public URL.
     */
    function initialize(address[] calldata jurisdictionAddresses, string calldata url) initializer public {
        __Ownable_init();
    ...
    /**
     * Create a new Series with initializer contract andMock custom plugins.
     ...
     * A contract initializerMock could previous
     *
     ...
     */
    function renewEntity(uint256 tokenId, uint256 periodInYears) payable public {
     ...
     */
    function addJurisdiction(address newAddress) public onlyOwner {
     ...
     */
    function updateJurisdiction(uint16 jurisdiction, address newAddress) public onlyOwner{
     ...
     */
    function changeBaseFees(uint256 newFee) public onlyOwner {
        baseFee = newFee;
     ...
     */
    function setMarketplaceAddresses(address[] calldata addresses, bool[] calldata enabled) public onlyOwner{
        uint256 i;
     ...
     */
    function changeURISources(address newEntitiesURI) public onlyOwner {
     ...
     */
    function changePriceFeed(address newPriceFeed) public onlyOwner {
     ...
     * Fees are transfered to the caller of the function that should be the contract owner.Mock
     *
