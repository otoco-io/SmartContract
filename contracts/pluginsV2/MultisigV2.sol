 ...
 * Multisig
 */
contract MultisigV2 is OtoCoPluginV2 {
    ...
    * @param pluginData Encoded parameters to create a new token.
    ...
    public onlySeriesOwner(seriesId) transferFees() payable override 
    {
        ...
        address multisigRemoved = 
        multisigDeployed[seriesId][toRemove];
        
        // Copy last token to the removed slot
        multisigDeployed[seriesId][toRemove] = 
        multisigDeployed[seriesId][multisigDeployed[seriesId].length - 1];
